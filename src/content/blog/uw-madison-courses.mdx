...
Below are the courses I've taken at <span class="text-accent">UW-Madison</span>. 
The credit count for each course is in parenthesis; if a credit count isn't indicated, a course is three credits. I was initially declared a double major in Computer Sciences 
...
Some courses are seminars or passion courses created by one professor. For those classes, I'll include the professor's name.
